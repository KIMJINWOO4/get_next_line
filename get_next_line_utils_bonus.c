...
/*   Updated: 2023/04/19 20:24:59 by jinwokim         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strjoin(char *s1, char *s2)
{
	...
	i = ft_strlenfree(s1, 0, 0);
	sum = i + ft_strlenfree(s2, 0, 0);
...
char	*ft_get_line(char *result)
{
	...
	if (arr == 0)
		return (0);
	ft_strlcpy(arr, result, (size_t)((size_t)new_line - (size_t)result + 2));
	return (arr);
}
